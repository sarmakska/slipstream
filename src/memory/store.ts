...
/**
 * The on disk layout. Memories live under .claude/slipstream/memory as one
 ...
 */
export const MEMORY_SUBDIR = join(".claude", "slipstream", "memory");
...
export function renderIndex(memories: Memory[]): string {
  ...
  lines.push("");
  lines.push(
    "This file is generated by slipstream. It lists every durable memory for " +
